...
<!-- Edit Profile -->
	...
	<?php
		$cq=mysqli_query($conn,"select * from staff left join `user` on user.userid=staff.userid where staff.userid='".$_SESSION['staffid']."'");
	...
	?>
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
				<div class="container-fluid">
                    <form role="form" method="POST" action="save_profile.php<?php echo '?id='.$_SESSION['staffid']; ?>" enctype="multipart/form-data">
						<div class="container-fluid">
